...
<Columns cols={2}>
  <Card
    title="EIP-7702"
    icon="link"
    href="/Smart-Wallets/introduction/Understanding-EIP-7702"
  >
  ...
  <Card
    title="ERC-4337"
    icon="link"
    href="/Smart-Wallets/introduction/Understanding-ERC-4337"
  >
...
<Card title="How-To Guides" icon="link" href="/Smart-Wallets/How-To-Guides">
